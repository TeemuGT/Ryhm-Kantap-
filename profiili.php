...
<section class="row tm-section tm-col-md-reverse">
  ...
  <div class="tm-flex-center p-5">
    ...
    <p class="mb-4">Etunimi: <?php echo $row["Etunimi"]; ?></p>
      ...
      <p class="mb-4">Sukupuoli: <?php echo $row["sahkoposti"]; ?></p>
      <p class="mb-4">Ikä: <?php echo $row["ika"]; ?></p>
      <p class="mb-4">Paino: <?php echo $row["paino"]; ?></p>
      <p class="mb-4">Pituus: <?php echo $row["pituus"]; ?></p>
      <p class="mb-4">Leposyke: <?php echo $row["leposyke"]; ?></p>
      <p class="mb-4">Maksimisyke: <?php echo $row["makssyke"]; ?></p>
      <br>
