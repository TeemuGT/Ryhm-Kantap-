...
<section class="row tm-section tm-col-md-reverse">
    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 p-0">
        <div class="tm-flex-center p-5 tm-bg-color-primary">
          ...
          <br>
          <p>UKK - instituutti julkaisi lokakuussa 2019 seuraavat, uudistetut liikuntasuositukset aikuisille. Lisää liikuntasuosituksista voit lukea
            <p><a href="https://www.ukkinstituutti.fi/liikkumisensuositus">TÄÄLTÄ</a></p></p>
          <br>
